...
?>
       <form action="properties.php" method="post">
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Property Address</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Image of Property</label>
                ...
                <div class="row mb-3">
                  <label for="inputDate" class="col-sm-2 col-form-label">Parking Availability</label>
                  <div class="col-sm-10">
                      <div class="form-check">
                ...
                <div class="row mb-3">
                  <label for="inputTime" class="col-sm-2 col-form-label">Property Tax Value</label>
                  <div class="col-sm-10">
